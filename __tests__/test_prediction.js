...
describe('Feature Extraction', () => {
    ...
    it('edge-fel has the correct ordering and results', async () => {
        ...
        expect(feats).toEqual([
            ...
            '0__median',
            '0__mean',
            '0__length', // this makes the test fail, write this after edge-fel length/abs-max is cleared
            '0__std_dev',
            '0__var',
            '0__root_mean_square',
            '0__max',
            '0__abs_max',
            '0__min', '1__sum', '1__median', '1__mean', '1__std_dev', '1__var', '1__root_mean_square', '1__max', '1__min', '2__sum', '2__median', '2__mean', '2__std_dev', '2__var', '2__root_mean_square', '2__max', '2__min'
        ])
        expect(values).toEqual([
            296,  30.71428680419922,
29.600000381469727, 14.899089813232422,
221.9828643798828,  33.13823699951172,
             49,                  5,
             71,                  9,
7.099999904632568, 3.9166314601898193,
15.340001106262207,  8.108637809753418,
             12,                  1,
          341.5,               42.5,
34.150001525878906, 15.614175796508789,
243.802490234375,  37.55030059814453,
             46,                  5
])
    })
})